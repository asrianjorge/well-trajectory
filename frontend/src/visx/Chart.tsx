...
// import CurveProps from Models;
// import {CurveType} from "Models.tsx";
// import {CurveProps} from "Models.tsx";
...
console.log(getX(series[0][0]), getY(series[0][0]))
...
export default function ExampleChart({ width, height, showControls = true }: CurveProps) {
